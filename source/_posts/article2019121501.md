---
title: springboot项目整合阿里开源框架EasyExcel，附带整理好的Excel操作工具类
tags:
  - Java
  - SpringBoot
  - EasyExcel
...
categories:
  - 后端
date: 2019-12-15 22:25:38
---
#### 本文旨在教你如何在springboot项目整合阿里开源框架EasyExcel，附带整理好的Excel操作工具类

前言：该博客主要是记录自己成长的点滴，当然也希望能够帮助到读者，路过的大佬们不喜勿喷~~~
<!-- more -->
#### EasyExcel重写了poi对07版Excel的解析，降低了内存消耗，对模型转换进行了封装，然后写了下简单案例。完整代码地址在结尾！！
...
import com.jinhaoxun.easyexceldemo.listener.ModelExcelListener;
import com.jinhaoxun.easyexceldemo.listener.StringExcelListener;
...
#### 第五步，编写单元测试类，EasyexcelDemoApplicationTests，并进行测试，使用方法基本都有注释
```
import com.alibaba.excel.metadata.BaseRowModel;
import com.alibaba.excel.support.ExcelTypeEnum;
...
后记：本次的“springboot项目整合阿里开源框架EasyExcel，附带整理好的Excel操作工具类”教程到此结束，有任何意见或建议，欢迎留言讨论~~~
